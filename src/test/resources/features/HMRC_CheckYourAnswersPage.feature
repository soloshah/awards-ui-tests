...
When I click on change otherPensionBenefits
...
When I click on change combinedLTA
...
When I click on change benefitCrysallisationDate
Then the separate pension benefits page will be displayed
...
When I click on change grossAnnualrate
Then the separate pension benefits page will be displayed
...
When I click on change separateBenefit
Then the separate pension benefits page will be displayed
...
When I click on change excessBenefit
