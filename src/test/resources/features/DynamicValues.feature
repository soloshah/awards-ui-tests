...
Then I go to partner nino page
And I enter same nino as of main applicant
Then the partner nino error message 'Spouse or Civil Partner National Insurance number must not be the same as your own.' will be displayed
