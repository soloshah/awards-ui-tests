...
public class PartnerGenderStepDefs {
	...
	public void thePartnerGenderPageWillBeDisplayed() {
		...
		assertThat(partnerGenderPage.getHeading()).contains("What is " + SharedData.firstName + "'s " + "legally recognised gender?");
	...
	@Given("^I enter partner details$")
	public void iEnterPartnerDetails() {
	partnerNameSteps =  new PartnerNameStepDefs();
	partnerNameSteps.iGoToThePartnerNamePage();
	partnerNameSteps.IenterValidPartnerNameDetails();
