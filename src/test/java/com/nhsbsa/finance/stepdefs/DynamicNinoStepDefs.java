...
public class DynamicNinoStepDefs {
	...
	public void iGoToDynamicPartnerNinoPage() {
		...
		assertThat(dynamicNinoPage.getHeading().contains("What is " + SharedData.firstName + "'s " +  "National Insurance number?"));
	}
	...
	public void theDynamicValueOfPartnersNameWillBeDisplayedOnThePartnersNinoPage() {
   		Page page = new Page(driver);
   		String partnerNinoPageTitle = "What is " + SharedData.firstName + "'s " +  "National Insurance number? - Claim your NHS Pension";
