...
public class HMRCDetails_CheckYourAnswersStepDefs {
	...
	public void theCorrectHmrcDetailsWillBeDisplayed() {
		...
		assertThat(hMRCDetails_CheckYourAnswerPage.getOtherPensions())
		...
		assertThat(hMRCDetails_CheckYourAnswerPage.getPensionOver30k()).matches(
		...
		assertThat(hMRCDetails_CheckYourAnswerPage.getAfterApril6())
				.matches("Yes - they were in payment on or after 6 April 2006");
		...
		assertThat(hMRCDetails_CheckYourAnswerPage.getBenefitDate())
				.matches("What is the date of first Benefit Crystallisation");
		assertThat(hMRCDetails_CheckYourAnswerPage.getBenefitDateText())
		...
		assertThat(hMRCDetails_CheckYourAnswerPage.getBeforeApril6())
				.matches("Yes – they were in payment before 6 April 2006");
		...
		assertThat(hMRCDetails_CheckYourAnswerPage.getSeparateBenefitsNoInformation())
				.matches("Do you have any separate pension benefits");
		...
		assertThat(hMRCDetails_CheckYourAnswerPage.getExcessLTA()).matches(
				"Would you like us to treat your NHS Pension Scheme benefits in the excess of the Lifetime Allowance");
		...
		assertThat(hMRCDetails_CheckYourAnswerPage.getLifetimeAllowance())
	...
	public void theCorrectHmrcDetailsWithUpdatedSeparateBenefitsWillBeDisplayed() {
		...
		assertThat(hMRCDetails_CheckYourAnswerPage.getSeparatePensionNoBenefits())
				.matches("Do you have any separate pension benefits");
		assertThat(hMRCDetails_CheckYourAnswerPage.getSeparatePensionNoBenefitsText())
				.matches(SharedData.sharedCheckBox);
	...
	public void theUpdatedValueForWillBeDisplayed(String field) {
		...
		switch (field) {
		case "pensionover30k":
			assertThat(hMRCDetails_CheckYourAnswerPage.getPensionOver30kText())
