...
public class NamePage extends Page {
  ...
  private By firstNameAnchoredErrorMessageAnchorLocator = By
      .xpath("//a[@href='#firstName']");
  ...
  private By lastNameAnchoredErrorMessageAnchorLocator = By
      .xpath("//a[@href='#lastName']");
